...
static constexpr auto qt_meta_stringdata_ZN9AboutPageE = QtMocHelpers::stringData(
    "AboutPage"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN9AboutPageE[] = {
...
Q_CONSTINIT const QMetaObject AboutPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN9AboutPageE.offsetsAndSizes,
    qt_meta_data_ZN9AboutPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9AboutPageE_t,
        // Q_OBJECT / Q_GADGET
...
void *AboutPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9AboutPageE.stringdata0))
