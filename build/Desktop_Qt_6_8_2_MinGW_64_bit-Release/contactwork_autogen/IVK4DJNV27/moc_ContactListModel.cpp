...
static constexpr auto qt_meta_stringdata_ZN16ContactListModelE = QtMocHelpers::stringData(
    "ContactListModel",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16ContactListModelE[] = {
...
Q_CONSTINIT const QMetaObject ContactListModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16ContactListModelE.offsetsAndSizes,
    qt_meta_data_ZN16ContactListModelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16ContactListModelE_t,
...
void ContactListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (ContactListModel::*)();
            if (_q_method_type _q_method = &ContactListModel::pIsSearchModeChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *ContactListModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16ContactListModelE.stringdata0))
...
// SIGNAL 0
void ContactListModel::pIsSearchModeChanged()
{
