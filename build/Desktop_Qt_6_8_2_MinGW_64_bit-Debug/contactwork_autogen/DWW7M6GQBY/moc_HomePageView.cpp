...
namespace {
struct qt_meta_tag_ZN12HomePageViewE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN12HomePageViewE = QtMocHelpers::stringData(
    "HomePageView"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN12HomePageViewE[] = {
...
Q_CONSTINIT const QMetaObject HomePageView::staticMetaObject = { {
    QMetaObject::SuperData::link<BaseView::staticMetaObject>(),
    qt_meta_stringdata_ZN12HomePageViewE.offsetsAndSizes,
    qt_meta_data_ZN12HomePageViewE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN12HomePageViewE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<HomePageView, std::true_type>
    >,
    nullptr
} };
...
void *HomePageView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN12HomePageViewE.stringdata0))
