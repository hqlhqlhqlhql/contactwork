...
QColor ContactItemDelegate::typeToColor(QString& type) const
{
...
QSize ContactItemDelegate::sizeHint(const QStyleOptionViewItem&,
                                    const QModelIndex&) const {
    return QSize(200, 70);  // 每个条目宽度和高度
}

// bool ContactItemDelegate::editorEvent(QEvent* event, QAbstractItemModel* model,
